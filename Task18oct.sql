...
INSERT INTO developer_personal_details(SLNO,DEVELOPER_name,DEVELOPER_PHONE_NUM,DEVELOPER_ID_NUM,DEVELOPER_INTERVIEW_DATE,
DEVELOPER,DEVELOPER_PLace,
DEVELOPER_Company_Name,Date_Of_Birth,Developer_role,Developer_project)
...
SELECT * FROM dEVELOPER_DETAILS WHERE SLNO =5;
SELECT * FROM dEVELOPER_DETAILS;

SELECT  DEVELOPER_name FROM dEVELOPER_DETAILS  WHERE DEVELOPER_name='Arun';
SELECT  SLNO,DEVELOPER_name FROM dEVELOPER_DETAILS  WHERE DEVELOPER_name='Arun';
SELECT DEVELOPER_PHONE_NUM FROM dEVELOPER_DETAILS WHERE DEVELOPER_PHONE_NUM=5;
